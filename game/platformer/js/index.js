...
import bulletEntity from './entities/bullet.js';
import { SlimeEnemyEntity, FlyEnemyEntity } from './entities/enemies.js';
import CoinEntity from './entities/coin.js';
import HoleEntity from './entities/hole.js'
import TitleScreen from './screens/Titel.js';
import PlayScreen from './screens/play.js';
import EndTitleScreen from './screens/End.js';
...
export default function onload() {
    ...
    me.loader.preload(resources, () => {
        ...
        me.state.set(me.state.GAME_END, new EndTitleScreen());
        ...
        me.pool.register("HoleEntity", HoleEntity, true);
